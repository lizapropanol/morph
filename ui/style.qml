        ...
        RowLayout {
            ...
            ColumnLayout {
                ...
                placeholderTextColor: "#666"
                                        ...
                                        ColumnLayout {
                                            Layout.fillWidth: true; spacing: 10
                                            Text { text: "Yandex Music Quality"; color: "#888"; font.family: mainFont.name; font.pixelSize: 11 }
                                            RowLayout {
                                                spacing: 10
                                                Button {
                                                    ...
                                                    background: Rectangle { color: ymLowQualBtn.active ? "white" : "#1a1a1a"; radius: 6; border.color: "#333" }
                                                }
                                                Button {
                                                    ...
                                                    background: Rectangle { color: ymHighQualBtn.active ? "white" : "#1a1a1a"; radius: 6; border.color: "#333" }
                                                }
                                            }
                                        }
                                        ColumnLayout {
                                            Layout.fillWidth: true; spacing: 10
                                            Text { text: "SoundCloud Quality"; color: "#888"; font.family: mainFont.name; font.pixelSize: 11 }
                                            RowLayout {
                                                spacing: 10
                                                Button {
                                                    ...
                                                    background: Rectangle { color: scLowQualBtn.active ? "white" : "#1a1a1a"; radius: 6; border.color: "#333" }
                                                }
                                                Button {
                                                    ...
                                                    background: Rectangle { color: scHighQualBtn.active ? "white" : "#1a1a1a"; radius: 6; border.color: "#333" }
                                                }
                                            }
                                        }
                                        Button {
